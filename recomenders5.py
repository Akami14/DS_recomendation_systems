...
class MainRecommender:
    ...
    def _get_recommendations(self, user, model, N=5):
        ...
        #filter_items = [] if self.false_id is not None else [self.itemid_to_id[self.false_id]]
        ...
        #print(self.user_item_matrix_for_pred[self.userid_to_id[user]])
    ...
    def get_own_recommendations(self, user, N=5):
        ...
        self._update_dict(user_id=user)
        rec = self.own_recommender.recommend(N = N, userid=user,
                    filter_already_liked_items=False,
                    filter_items=filter_items,
                    recalculate_user=True)[0]
        return rec
    ...
    # similar_items пока не работает
